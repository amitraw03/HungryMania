...
const BgVideo = () => {
  return (
    <div>
       <div className='w-[740px] md:w-full'>
           <video autoPlay muted loop poster="https://www.foodpanda.com/wp-content/uploads/2023/03/fp-home-video-poster.jpg" className='h-[400px]  md:h-[480px] w-full object-cover'>
